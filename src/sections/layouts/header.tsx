      ...
      links: [
        {
          ...
          label:
            'Learn more about our starter code small business web design services',
        },
        {
          name: 'Custom design & software development',
          href: '/',
          label:
            'Learn more about our starter code custom design and software development services',
          disabled: true,
        },
      ],
    },
      ...
      <section className="section-container grid grid-cols-4 items-center py-6 max-lg:hidden 3xl:py-8">
        ...
        <nav className="col-span-2">
          <ul className="grid h-full grid-cols-3">
            {/* <li className="group relative mx-auto flex h-auto px-1 py-3">
              <Link
                href={'/about'}
        ...
        <div className="flex justify-center">
          <Link
            className="button-primary free-consultation-link w-10/12"
            href="/contact"
          ...
          >
            <div className="overflow-hidden">
              ...
              <div className=" flex w-full flex-col items-center justify-end gap-3 px-4 pb-1">
                <Link
                  aria-label="Get a free consultation now with starter code"
                  className="button-primary free-consultation-link w-full max-w-none py-4 text-center"
                  onClick={mobileMenuHandler}
                  href="/contact"
                  tabIndex={!mobileMenuOpen ? -1 : 0}
                >
